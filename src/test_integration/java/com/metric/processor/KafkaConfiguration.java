...
public class KafkaConfiguration {
    ...
    public DefaultKafkaConsumerFactory<String, EventDTO> consumerFactory(KafkaEmbedded embeddedKafka) {
    ...
    public ProducerFactory<String, TemperatureDTO> producerFactory(KafkaEmbedded embeddedKafka) {
        Map<String, Object> props =
